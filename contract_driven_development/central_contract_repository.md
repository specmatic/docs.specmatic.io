...
Both consumers and providers can leverage the specifications in the Central Contract Repository by listing it in [Specmatic configuration](/references/configuration.html). Example:
...
[**Specmatic Configuration in detail**](/references/configuration.html)
