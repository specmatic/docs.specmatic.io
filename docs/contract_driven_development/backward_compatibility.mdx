...
:::info
Backward compatibility HTML report is already produced by the open source version. However, for governance and deeper integration with other tools in your ecosystem, the Enterprise version also produces a json CTRF report.
:::
