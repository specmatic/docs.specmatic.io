...
See [Reports Sent to Insights](/enterprise_onboarding/insights/reports_sent_to_insights#central-contract-repository-report-payload) for the JSON payload published when this report is sent with `send-report`.
