...
- run the Spec Metadata Report flow separately for each federated contract repository
...
- the `Spec Repository` block comes from the `order-contracts` Spec Metadata Report
...
- the `Spec Repository` block comes from the `payment-contracts` Spec Metadata Report
...
- make sure the relevant Spec Metadata Report was generated from the correct federated contract repository and posted to Insights
