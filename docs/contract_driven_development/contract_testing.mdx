...
See [Reports Sent to Insights](/enterprise_onboarding/insights/reports_sent_to_insights#contract-test-report-payload) to publish the CTRF report with `send-report`.
