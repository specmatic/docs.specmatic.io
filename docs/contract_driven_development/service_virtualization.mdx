...
<Tabs groupId="test">
  ...
  <TabItem value="java" label="java">
```shell
java -jar specmatic.jar mock --httpsKeyStoreDir=<directory to create keystore> --port=443 product-api.yaml
```
  </TabItem>

  <TabItem value="npm" label="npm">
```shell
npx specmatic mock --httpsKeyStoreDir=<directory to create keystore> --port=443 product-api.yaml
```
  </TabItem>

  <TabItem value="docker" label="docker">
```shell
docker run -p 443:443 -v "${PWD}/product-api.yaml:/usr/src/app/product-api.yaml" -v "${PWD}/<directory to create keystore>:/usr/src/app/<directory to create keystore>" specmatic/specmatic mock --httpsKeyStoreDir=<directory to create keystore> --port=443 product-api.yaml
```
  </TabItem>
