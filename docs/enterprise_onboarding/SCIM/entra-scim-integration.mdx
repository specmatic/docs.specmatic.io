...
For the user-facing meaning of those role and account type combinations, see [Role Permissions](/enterprise_onboarding/role_permissions).
...
Use [Role Permissions](/enterprise_onboarding/role_permissions) to choose the right target combination for each synced group.
