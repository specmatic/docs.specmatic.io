...
1. A Spec Metadata Report establishes the available specifications and operations.
...
- **Specification is missing:** confirm that the Spec Metadata Report was published.
...
- **Counts are unexpected:** check the latest Spec Metadata and service build reports, including the specification and operation identity used by each report.
