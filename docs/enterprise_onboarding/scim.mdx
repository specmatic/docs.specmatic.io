...
For what each mapped role and account type is allowed to do after SCIM hydration, see [Role Permissions](/enterprise_onboarding/role_permissions).
...
See [Role Permissions](/enterprise_onboarding/role_permissions) for the practical meaning of those combinations in Insights.
...
Use [Role Permissions](/enterprise_onboarding/role_permissions) to decide which combination each group should receive.
