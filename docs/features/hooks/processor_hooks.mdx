...
# Request and Response Processing <CommercialBadge/>

Specmatic's data adapters let you transform traffic that comes to the mock or proxy server. They are useful when the provider and consumer speak a wire format that differs in some way from the actual data that traverses the wire.
...
<V2V3SpecmaticConfigTabs
  v3Object={require('../../references/configuration/hooks/includes/hooks/v3/simple/specmatic.json')}
  v2Object={require('../../references/configuration/hooks/includes/hooks/v2/simple/specmatic.json')}
/>
