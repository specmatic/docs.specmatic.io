...
## How matchers work in test and mock
...
In contract testing, Specmatic sends the request POST `{"userId": 10}` to /verifyUser and then evaluates the matcher against the response returned by the application.
