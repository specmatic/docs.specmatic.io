...
Specmatic can be used as a standalone executable and also included [programmatically](/contract_driven_development/service_virtualization#programmatically-starting-mock-server-within-tests) as part of your test suite.
...
Using Specmatic Enterprise license initialized from jar:file:/usr/local/share/specmatic/specmatic.jar!/default-oss-license.txt
