...
## Representative Complete Configuration

This example shows the main configuration sections working together. Protocol-specific run options and less commonly used settings are documented on the Test Configuration and Mock Configuration pages.
...
<V2V3SpecmaticConfigTabs
  v3Object={yaml.load(require('./includes/complete-examples/mtls-test/v3/specmatic.yaml?raw'))}
  v2Object={yaml.load(require('./includes/complete-examples/mtls-test/v2/specmatic.yaml?raw'))}
/>

### Mock with incoming mTLS enabled (client cert required)

<V2V3SpecmaticConfigTabs
  v3Object={yaml.load(require('./includes/complete-examples/mtls-mock/v3/specmatic.yaml?raw'))}
  v2Object={yaml.load(require('./includes/complete-examples/mtls-mock/v2/specmatic.yaml?raw'))}
/>
