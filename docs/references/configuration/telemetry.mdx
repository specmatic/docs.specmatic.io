...
[Specmatic Insights](/enterprise_onboarding/insights/overview) provides reports on coverage, service dependency graphs, adoption by providers and consumers etc.
