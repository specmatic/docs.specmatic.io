...
A [central contract repository](../contract_driven_development/contract_repositories/central_contract_repository.mdx) is crucial for maintaining consistency across your API specifications and enabling effective contract testing.
...
Else you can follow the [setup instructions](../contract_driven_development/contract_repositories/central_contract_repository.mdx#setting-up-a-sample-central-contract-repository) to create a sample central contract repo.
...
* lint the specifications using the Specmatic linter
