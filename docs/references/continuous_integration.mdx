...
Else you can follow the [setup instructions](../contract_driven_development/central_contract_repository.mdx#setting-up-a-sample-central-contract-repository) to create a sample central contract repo.
