...
A [central contract repository](../contract_driven_development/central_contract_repository.mdx) is crucial for maintaining consistency across your API specifications and enabling effective contract testing.
...
Else you can follow the [setup up instructions](../contract_driven_development/central_contract_repository.mdx#setting-up-a-sample-central-contract-repository) to create one a sample central contact repo.
...
### Adding Specmatic Linter for governance

If you use Specmatic Enterprise for OpenAPI governance, you can add Specmatic Linter alongside syntax linting. This is useful when you want profile-driven semantic rules, configurable organization-specific rules, maturity reporting, or a central lint-config repository.

See:

- [Specmatic Linter](/linting)
- [Central Config Repo](/linting/central-config-repo)
...
- [GitLab CI](https://gitlab.com/znsio/contract_driven_development/central-contract-repository/-/pipelines)
...
Please go through the detailed [Specmatic Insights guide](/enterprise_onboarding/insights.mdx) to integrate Specmatic Insights in your CI/CD pipelines.
