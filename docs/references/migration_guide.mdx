...
Legacy build reporter support has been removed. If your CI pipeline still uses either of the integrations below, replace them with `specmatic send-report`.
