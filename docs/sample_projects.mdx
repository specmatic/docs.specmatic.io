...
If you want a focused walkthrough of Specmatic Enterprise's OpenAPI linting capability, use the dedicated sample project:

- [specmatic-linter-sample](https://github.com/specmatic/specmatic-linter/tree/main/sample_projects/specmatic-linter-sample)
...
| Kafka    | Request-Reply       | Kotlin   | Spring Boot | [specmatic-kafka-sample-asyncapi3](https://github.com/specmatic/specmatic-kafka-sample-asyncapi3) |
...
| JSON Schema Draft-07 (Kafka) | Kotlin | Spring Boot | [specmatic-kafka-json-schema-sample](https://github.com/specmatic/specmatic-kafka-json-schema-sample) |

See [Confluent Schema Registry support](/features/asyncapi/confluent-schema-registry) for setup and configuration.
  </TabItem>
