...
**Config Approach:** Specify example directories in your `specmatic.yaml` configuration file under `exampleDirs`. For example:
...
**Config Approach:** Specify example directories in your `specmatic.yaml` configuration file under the `config` section. For example:
