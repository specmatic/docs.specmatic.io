...
- Additionally, if you're working with a JVM-based language, this can also be executed programmatically. For more information, please consult [Programmatically Executing Specmatic Mocks](/contract_driven_development/service_virtualization#programmatically-starting-mock-server-within-tests)
