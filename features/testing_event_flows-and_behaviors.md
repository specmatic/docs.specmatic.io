...
<!-- TOC -->
* [Testing Event Flows and Behaviors](#testing-event-flows-and-behaviors)
  * [Introduction to Event Flows and Behaviors](#introduction-to-event-flows-and-behaviors)
  * [Business Workflow](#business-workflow)
  * [Triggers and Side Effects](#triggers-and-side-effects)
    * [Triggering Event Flows](#triggering-event-flows)
    * [Side Effects of Event Consumption](#side-effects-of-event-consumption)
  * [Testing Triggers and Side Effects with Specmatic](#testing-triggers-and-side-effects-with-specmatic)
    * [OpenAPI Overlays](#openapi-overlays)
...
![API Workflow](/images/async_workflow.gif)
...
### OpenAPI Overlays
[OpenAPI Overlays](/features/overlays.html) provides a powerful mechanism to modify OpenAPI specifications without altering the base specification.
