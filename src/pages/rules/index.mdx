...
The filter expression specified in the [Specmatic Config](./contract_driven_development/contract_testing#specmatic-config) does not allow this operation to be executed.
